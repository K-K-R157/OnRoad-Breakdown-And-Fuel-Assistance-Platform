...
mechanicRequestSchema.methods.updateStatus = async function(newStatus, notes = '') {
...
mechanicRequestSchema.methods.cancelRequest = async function(reason, cancelledBy) {
...
mechanicRequestSchema.statics.getActiveRequests = function(userId) {
  return this.find({
    user: userId,
    status: { $in: ['pending', 'accepted', 'en-route', 'arrived', 'in-progress'] }
  })
...
mechanicRequestSchema.statics.getMechanicActiveRequests = function(mechanicId) {
  return this.find({
    mechanic: mechanicId,
